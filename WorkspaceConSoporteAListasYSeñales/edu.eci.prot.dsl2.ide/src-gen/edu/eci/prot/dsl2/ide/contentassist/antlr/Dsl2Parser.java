		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getEntityAccess().getSignalAssignment_3_0(), "rule__Entity__SignalAssignment_3_0");
					put(grammarAccess.getEntityAccess().getFiltersAssignment_3_1(), "rule__Entity__FiltersAssignment_3_1");
					put(grammarAccess.getEntityAccess().getPrincipalAssignment_5(), "rule__Entity__PrincipalAssignment_5");
					put(grammarAccess.getEntityAccess().getImportsAssignment_6(), "rule__Entity__ImportsAssignment_6");
