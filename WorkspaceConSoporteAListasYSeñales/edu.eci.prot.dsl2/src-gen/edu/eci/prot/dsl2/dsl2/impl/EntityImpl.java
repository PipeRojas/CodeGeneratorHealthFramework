 ...
 *   <li>{@link edu.eci.prot.dsl2.dsl2.impl.EntityImpl#isSignal <em>Signal</em>}</li>
 *   <li>{@link edu.eci.prot.dsl2.dsl2.impl.EntityImpl#getFilters <em>Filters</em>}</li>
...
public class EntityImpl extends TypeImpl implements Entity
{
  ...
  public void setSignal(boolean newSignal)
  {
    ...
    signal = newSignal;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Dsl2Package.ENTITY__SIGNAL, oldSignal, signal));
  }
  ...
  public EList<String> getFilters()
  {
    if (filters == null)
    {
      filters = new EDataTypeEList<String>(String.class, this, Dsl2Package.ENTITY__FILTERS);
    }
    return filters;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case Dsl2Package.ENTITY__SIGNAL:
        return isSignal();
      case Dsl2Package.ENTITY__FILTERS:
        return getFilters();
