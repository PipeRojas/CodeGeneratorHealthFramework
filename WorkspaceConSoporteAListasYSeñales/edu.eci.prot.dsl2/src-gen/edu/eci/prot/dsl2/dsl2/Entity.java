 ...
 *   <li>{@link edu.eci.prot.dsl2.dsl2.Entity#isSignal <em>Signal</em>}</li>
 *   <li>{@link edu.eci.prot.dsl2.dsl2.Entity#getFilters <em>Filters</em>}</li>
...
public interface Entity extends Type
{
   ...
   * @see edu.eci.prot.dsl2.dsl2.Dsl2Package#getEntity_Signal()
   * @model
   * @generated
   */
  boolean isSignal();
  ...
  /**
   * Sets the value of the '{@link edu.eci.prot.dsl2.dsl2.Entity#isSignal <em>Signal</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see edu.eci.prot.dsl2.dsl2.Dsl2Package#getEntity_Filters()
   * @model unique="false"
   * @generated
   */
