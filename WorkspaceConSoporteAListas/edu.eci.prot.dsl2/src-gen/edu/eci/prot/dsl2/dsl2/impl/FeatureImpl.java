 ...
 *   <li>{@link edu.eci.prot.dsl2.dsl2.impl.FeatureImpl#getItems <em>Items</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FeatureImpl extends MinimalEObjectImpl.Container implements Feature
{
  ...
  public EList<String> getItems()
  {
    if (items == null)
    {
      items = new EDataTypeEList<String>(String.class, this, Dsl2Package.FEATURE__ITEMS);
    }
    return items;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case Dsl2Package.FEATURE__TYPE:
        ...
        return basicGetType();
      case Dsl2Package.FEATURE__ITEMS:
        return getItems();
    }
